export const themes = {
  ...
  emerald: {
    ...
    light: {
      ...
      popover: "oklch(1 0 0)",
      "popover-foreground": "oklch(0.12 0.015 260)",
      primary: "oklch(0.68 0.17 270)",
      "primary-foreground": "oklch(0.98 0 0)",
      secondary: "oklch(0.96 0.008 260)",
      "secondary-foreground": "oklch(0.22 0.015 260)",
      muted: "oklch(0.96 0.008 260)",
      "muted-foreground": "oklch(0.48 0.01 260)",
      accent: "oklch(0.68 0.17 270)",
      "accent-foreground": "oklch(0.98 0 0)",
      border: "oklch(0.92 0.008 260)",
      input: "oklch(0.92 0.008 260)",
      ring: "oklch(0.68 0.17 270)",
      "glow-color": "oklch(0.68 0.17 270 / 0.15)",
      "glow-color-strong": "oklch(0.68 0.17 270 / 0.25)",
    },
    dark: {
      background: "oklch(0.06 0.015 260)",
      foreground: "oklch(0.96 0 0)",
      ...
      "glow-color": "oklch(0.72 0.16 270 / 0.12)",
      "glow-color-strong": "oklch(0.72 0.16 270 / 0.22)",
    },
  },
  rose: {
    name: "Rose",
