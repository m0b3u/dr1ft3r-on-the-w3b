export const themes = {
  ...
  emerald: {
    ...
    light: {
      ...
      "glow-color": "oklch(0.70 0.16 160 / 0.15)",
      "glow-color-strong": "oklch(0.70 0.16 160 / 0.25)",
    },
    dark: {
      background: "oklch(0.06 0.015 260)",
      foreground: "oklch(0.96 0 0)",
      ...
      muted: "oklch(0.16 0.015 260)",
      "muted-foreground": "oklch(0.58 0 0)",
      accent: "oklch(0.74 0.15 160)",
      "accent-foreground": "oklch(0.1 0.01 260)",
      border: "oklch(0.2 0.015 260)",
      input: "oklch(0.2 0.015 260)",
      ring: "oklch(0.74 0.15 160)",
      "glow-color": "oklch(0.74 0.15 160 / 0.12)",
      "glow-color-strong": "oklch(0.74 0.15 160 / 0.22)",
    },
  },
  rose: {
    name: "Rose",
